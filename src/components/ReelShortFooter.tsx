    ...
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" aria-hidden>
            <g transform="translate(-1287 -3564)">
                ...
                <g style={{ opacity: 0.5 }} fill="#fff">
                    <path d="M1307.381 3571.429h-8.762a4.2 4.2 0 0 0-4.19 4.191v8.762a4.2 4.2 0 0 0 4.19 4.191h8.762a4.2 4.2 0 0 0 4.19-4.191v-8.762a4.2 4.2 0 0 0-4.19-4.191m-8.762 1.347h8.762a2.846 2.846 0 0 1 2.843 2.844v8.762a2.846 2.846 0 0 1-2.843 2.843h-8.762a2.846 2.846 0 0 1-2.843-2.843v-8.762a2.846 2.846 0 0 1 2.844-2.844Z" />
                    <path d="M1303.009 3584.33a4.508 4.508 0 0 0 .979-.108 4.284 4.284 0 0 0 3.233-3.233 4.341 4.341 0 0 0-5.209-5.208 4.281 4.281 0 0 0-3.233 3.232 4.336 4.336 0 0 0 4.23 5.318Zm-2.118-6.437a2.968 2.968 0 0 1 2.113-.875 3.163 3.163 0 0 1 .813.108 2.943 2.943 0 0 1 2.059 2.059 3 3 0 0 1-3.692 3.691 2.943 2.943 0 0 1-2.059-2.059 3 3 0 0 1 .767-2.925Z" />
                    <circle cx="0.924" cy="0.924" r="0.924" transform="rotate(-13.282 16004.837 -3823.117)" />
                </g>
            </g>
        </svg>
    );
...
function IconFandom() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32" height="32" fill="none" aria-hidden>
...
export function ReelShortFooter() {
    ...
    const supportEmail = intl.formatMessage({ id: 'footer_support_email' });
    const mediaEmail = intl.formatMessage({ id: 'footer_media_email' });

    return (
        <footer className="reelshort-footer">
            <div className="reelshort-footer__h5 md:hidden">
                <div>
            ...
            {/* 仅 PC（≥md）：多栏 + 社媒图标 + Download，与 ReelShort 离线图 Footer_* 结构一致；H5 不渲染 */}
            <div className="reelshort-footer__pc hidden md:block Footer_footer_box__Y_9Qb">
                    ...
                    <div className="Footer_footer_list__BY2Iy">
                        <div className="Footer_footer_item__Jzv7v">
                            <div className="Footer_item_title__7csub">
                                <FormattedMessage id="footer_pc_section_about" />
                            </div>
                            <div className="Footer_item_sub_title__VYtUB">
                                <Link to="/page/text?title=user_agreement" className="Footer_item_sub_text__EQ_F8">
                                    <FormattedMessage id="footer_pc_terms" />
                                </Link>
                            </div>
                            <div className="Footer_item_sub_title__VYtUB">
                                <Link to="/page/text?title=privacy_policy" className="Footer_item_sub_text__EQ_F8">
                                    <FormattedMessage id="footer_pc_privacy" />
                                </Link>
                            </div>
                            <div className="Footer_item_sub_title__VYtUB">
                                <a href={`mailto:${supportEmail}`} rel="nofollow" className="Footer_item_sub_text__EQ_F8">
                                    <FormattedMessage id="footer_pc_contact" />
                                </a>
                                <p className="Footer_tips__9X00v">
                        ...
                        <div className="Footer_footer_item__Jzv7v">
                            <div className="Footer_item_title__7csub">
                                <FormattedMessage id="footer_pc_section_support" />
                            </div>
                            <div className="Footer_item_sub_title__VYtUB">
                                <Link to="/page/feedback" className="Footer_item_sub_text__EQ_F8">
                                    <FormattedMessage id="footer_pc_feedback" />
                                </Link>
                            </div>
                            <div className="Footer_item_sub_title__VYtUB">
                                <a href={`mailto:${mediaEmail}`} rel="nofollow" className="Footer_item_sub_text__EQ_F8">
                        ...
                        <div className="Footer_footer_item__Jzv7v">
                            <div className="Footer_item_title__7csub">
                                <FormattedMessage id="footer_pc_section_community" />
                            </div>
                            <div className="Footer_direction_horizontal__JXJpf">
                                <div className="Footer_icons__CM1hG">
                                    <a
                                        href="https://www.facebook.com/ReelShortTV/"
                                        target="_blank"
                                        rel="noreferrer"
                                ...
                                <div className="Footer_icons__CM1hG">
                                    <a
                                        href="https://www.youtube.com/@reelshortapp"
                                        target="_blank"
                                        rel="noreferrer"
                                        className="text-white/90"
                                    >
                                ...
                                <div className="Footer_icons__CM1hG">
                                    <a
                                        href="https://www.instagram.com/reelshortapp/"
                                        target="_blank"
                                        rel="noreferrer"
                                        className="text-white/90"
                                    >
                                ...
                                <div className="Footer_icons__CM1hG">
                                    <a href="https://www.tiktok.com/@reelshortapp" target="_blank" rel="noreferrer" className="text-white/90">
                                        <IconTiktok />
                                    </a>
                                </div>
                                <div className="Footer_icons__CM1hG">
                                    <a
                                        href="https://reelshort.fandom.com/wiki/Local_Sitemap"
                                        target="_blank"
                                        rel="noreferrer"
                                        className="text-white/90"
                                    >
                        ...
                        <div className="Footer_footer_item__Jzv7v">
                            <div className="Footer_item_title__7csub">
                                <FormattedMessage id="footer_pc_section_download" />
                            </div>
                            <div className="Footer_direction_vertical__AzlqL">
                                <div className="Footer_icons__CM1hG">
                                    <div className="reelshort-footer__download-box overflow-hidden rounded-[6.8px]">
                                        <img
                                            src="/logo.png"
                                            alt={intl.formatMessage({ id: 'footer_pc_download_qr_alt' })}
                                            width={136}
                                            height={136}
