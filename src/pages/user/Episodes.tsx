...
export default function Component() {
    ...
    // playbackRate 仅用于长按 2X/视频事件对齐；不做 UI 展示时无需单独 state
    ...
    const [defLabel, setDefLabel] = useState<'Auto' | '1080P' | '720P'>('1080P');
    ...
    const localImg = (file: string) => new URL(`../../assets/images/${file}`, import.meta.url).toString();
        ...
        async function load() {
            ...
            try {
                ...
                if (bookId && chapterId) {
                    ...
                    const d = (res as any).d?.data ?? (res as any).d ?? {};
    ...
    // 清晰度/倍速的真实切换映射后续接入 HLS levels 再做

    async function toggleFullscreen() {
        // 移动端兜底策略：
        // - iOS Safari：必须走 video.webkitEnterFullscreen / webkitEnterFullScreen
        // - Android/Chrome：优先 video.requestFullscreen，再回退容器 requestFullscreen
        const wrap = scrollRef.current;
        const video = videoRef.current as (HTMLVideoElement & {
            webkitEnterFullscreen?: () => void;
            webkitExitFullscreen?: () => void;
            webkitEnterFullScreen?: () => void; // 旧写法
        }) | null;
        ...
        if (fsEl) {
            ...
            if (doc.webkitExitFullscreen) await Promise.resolve(doc.webkitExitFullscreen()).catch(() => { });
            return;
        }

        // iOS：video 专用全屏（必须用户手势同步触发）
        if (video?.webkitEnterFullscreen) {
            try {
                video.webkitEnterFullscreen();
            } catch {
                // ignore: iOS 可能抛异常但仍会尝试切全屏
            }
            return;
        }
        if (video?.webkitEnterFullScreen) {
        ...
        // Android/Chrome：优先对 video 本体请求全屏
        ...
        // 最后回退：对容器请求全屏
        const el = (wrap ?? video?.parentElement) as (HTMLElement & { webkitRequestFullscreen?: () => Promise<void> | void }) | null;
        if (!el) return;
    ...
    function bumpControls() {
        setControlsVisible(true);
        clearControlsTimer();
        // 对标 ReelShort：暂停时 controls 不自动隐藏
        ...
        <div className="rs-episodes">
            <div className="rs-episodes__scroll" ref={scrollRef}>
                <div className="rs-episodes__topnav">
                    <ReelShortTopNav scrollParentRef={topNavScrollParentRef} showPrimaryNav />
                </div>
                ...
                <main className="rs-episodes__main">
                    <div className="rs-episodes__playerShell">
                                            ...
                                            <xg-left-grid className="xg-left-grid">
                                                ...
                                                >
                                                    <div className="xgplayer-icon">
                                                        <img
                                                            src={localImg('dc205410-d6cd-11ee-94ca-b3f9375866ba.png')}
                                                            width={17}
                                                            height={17}
                                                        ...
                                                        />
                                                        <img
                                                            src={localImg('db028800-d6cd-11ee-94ca-b3f9375866ba.png')}
                                                            width={17}
                                                            height={17}
                                                ...
                                                >
                                                    <img
                                                        src={localImg('12164930-c692-11ef-a2d6-41216ff1602c.png')}
                                            ...
                                            <xg-center-grid className="xg-center-grid">
                                                <xg-progress className="xgplayer-progress" data-index="0">
                                                    <xg-outer
                                                        ...
                                                        ref={seekBarRef as unknown as React.Ref<HTMLDivElement>}
                                                        ...
                                                        onPointerMove={(e: React.PointerEvent<HTMLDivElement>) => updateSeeking(e.clientX)}
                                                        onPointerUp={() => commitSeeking()}
                                                        onPointerCancel={() => setXgAction('none')}
                                                    >
                                                        <xg-inners className="progress-list">
                                                            <xg-inner className="xgplayer-progress-inner" style={{ background: 'rgba(255,255,255,0.2)', flex: 1 }}>
                                                                <xg-cache
                                ...
                                <div className="rs-episodes__lockMask">
                                    ...
                                    >
                                        <img
                                            ...
                                            src={localImg('7f47ede0-ef83-11f0-84ad-6b5693b490dc.png')}
                                            alt=""
                                        />
                                        ...
                                        >
                                            <i
                                                className="mr-4px block w-16/vw h-16/vw md:w-20px md:h-20px bg-cover bg-center bg-no-repeat"
                                                style={{ backgroundImage: `url(${localImg('f7c9e180-f053-11f0-84ad-6b5693b490dc.png')})` }}
                                                aria-hidden
                                            />
                                        ...
                                        >
                                            <i
                                                className="block w-24px h-24px bg-cover bg-center bg-no-repeat"
                                                style={{ backgroundImage: `url(${localImg('36440c80-ef8a-11f0-84ad-6b5693b490dc.png')})` }}
                                                aria-hidden
                                            />
                                            在 ReelShort 應用中觀看
                                        </button>
                        ...
                        <div className="rs-episodes__below" ref={topNavScrollParentRef}>
                            <div className="shrink-1 touch-none overflow-auto">
                                <div className="pb-25/vw">
                                        ...
                                        <div role="tab-list" className="flex items-center justify-between overflow-hidden rounded-md p-0 h-20/vw mb-6/vw">
                                            ...
                                            <Dialog open={allOpen} onOpenChange={setAllOpen}>
                                                ...
                                                <DialogContent className="rs-episodes__allDialog" hideCloseButton>
                                                    <DialogTitle className="sr-only">全集</DialogTitle>
                                                ...
                                                return (
                                                    <div
                                                        ...
                                                        className={cn(
                                                            ...
                                                            isCur && 'rs-episodes__epBtn--active',
                                                        )}
                                                        onClick={() => {
                                                            if (locked) {
                                                                setPayOpen(true);
                            ...
                            <div className="rs-episodes__actions">
                                <div className="flex flex-1 cursor-pointer flex-col items-center justify-center text-white/90 md:text-white/70">
                                    <div className="flex text-24/vw md:text-32px">
                                        <span role="img" className="anticon text-white/90 md:text-white/70">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" width="1em" height="1em" aria-hidden="true" focusable="false">
                                                <path
                                                    fill="currentColor"
                                                    fillOpacity="0.9"
                                    ...
                                    <span className="mt-4/vw flex text-14/vw md:mt-4px md:text-14px">{likeCount}</span>
                                </div>
                                ...
                                <div className="flex flex-1 cursor-pointer flex-col items-center justify-center text-white/90 md:text-white/70">
                                    ...
                                    <span className="mt-4/vw flex text-14/vw md:mt-4px md:text-14px">{collectCount}</span>
                                </div>
                                ...
                                <div className="flex flex-1 cursor-pointer flex-col items-center justify-center text-white/90 md:text-white/70">
                                    ...
                                    <span className="mt-4/vw flex text-14/vw md:mt-4px md:text-14px">分享</span>
                                </div>
                            </div>

                            {/* Footer 必须参与下半区滚动（不是定位悬浮） */}
                            <ReelShortFooter />
                        </div>
                    </div>
            ...
            {/* VIP/充值/支付：对标 ReelShort，用底部 Drawer（从下往上滑出） */}
            <Drawer open={payOpen} onOpenChange={setPayOpen}>
                <DrawerContent className="rs-paywall__dialog">
                    <DrawerA11yTitle className="sr-only">支付</DrawerA11yTitle>
                        ...
                        <div className="rs-paywall__inner">
                            <div className="rs-paywall__stickyHead">
                                <div className="rs-paywall__headLeft">
                                    <span className="rs-paywall__kv">
                                        ...
                                        <img
                                            ...
                                            src={localImg('f7c9e180-f053-11f0-84ad-6b5693b490dc.png')}
                                            alt=""
                                        />
                                ...
                                <button type="button" className="rs-paywall__close" onClick={() => setPayOpen(false)} aria-label="close">
                                    <img
                                        src={localImg('a9a3d800-ef98-11f0-84ad-6b5693b490dc.png')}
                            ...
                            <div className="rs-paywall__bodyScroll">
                                            ...
                                            <div className="rs-paywall__vipFoot">
                                                <div className="rs-paywall__vipFeat">
                                                    <img
                                                        ...
                                                        src={localImg('b2e3e770-f047-11f0-84ad-6b5693b490dc.png')}
                                                        alt=""
                                                    />
                                                    無限觀看
                                                </div>
                                                <div className="rs-paywall__vipFeat">
                                                    <img
                                                        className="rs-paywall__featIcon"
                                                        src={localImg('b2e2fd10-f047-11f0-84ad-6b5693b490dc.png')}
                                                        alt=""
                                                    />
                                                    1080p 高畫質
                                                </div>
                                ...
                                <div className="rs-paywall__section">
                                    ...
                                    <button
                                        type="button"
                                        className="rs-paywall__more"
                                        onClick={() => {
                                            const locale = params['locale'];
                                            setPayOpen(false);
                                            navigate(locale ? `/${locale}/shopping` : '/shopping');
                                        }}
                                    >
                                        更多方案
                                    ...
                                    <div className="rs-paywall__payGrid">
                                        <button type="button" className="rs-paywall__payBtn is-active">
                                            <img
                                                ...
                                                src={localImg('98236390-f063-11f0-84ad-6b5693b490dc.png')}
                                                alt=""
                                            />
                                        ...
                                        <button type="button" className="rs-paywall__payBtn">
                                            <img
                                                ...
                                                src={localImg('55516d00-ec94-11f0-84ad-6b5693b490dc.png')}
                                                alt=""
                                            />
                                        </button>
                                        <button type="button" className="rs-paywall__payBtn">
                                            <img
                                                className="rs-paywall__payIconWide"
                                                src={localImg('5552a580-ec94-11f0-84ad-6b5693b490dc.png')}
                                                alt=""
                                            />
                                        </button>
                                    </div>
